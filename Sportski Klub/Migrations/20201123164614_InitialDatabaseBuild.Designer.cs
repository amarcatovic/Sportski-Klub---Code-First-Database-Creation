...
namespace Sportski_Klub.Migrations
{
    ...
    [Migration("20201123164614_InitialDatabaseBuild")]
            ...
            modelBuilder.Entity("Sportski_Klub.Models.ClubMedia", b =>
                {
                    ...
                    b.Property<int?>("ClubMediaClubId")
                        .HasColumnType("int");

                    b.Property<int?>("ClubMediaMediaId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("ClubMediaPublishDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ClubMediaClubId", "ClubMediaMediaId", "ClubMediaPublishDate");
            ...
            modelBuilder.Entity("Sportski_Klub.Models.ClubMedia", b =>
                {
                    ...
                    b.HasOne("Sportski_Klub.Models.ClubMedia", null)
                        .WithMany("MediaClub")
                        .HasForeignKey("ClubMediaClubId", "ClubMediaMediaId", "ClubMediaPublishDate");
